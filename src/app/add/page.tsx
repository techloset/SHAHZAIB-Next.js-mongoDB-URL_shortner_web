        ...
        <div className="flex flex-col">
          <div className="flex flex-row relative">
            ...
            <input
              ...
              className="w-[1100px] h-[76px] rounded-[48px] border-[4px] border-gray-400 bg-slate-800 mt-10 "
            />
          </div>
          <div className="flex flex-row relative">
            <span className="h-[25px] w-[25] absolute ml-10 mt-16 ">
            ...
            <input
              ...
              className="w-[1100px] h-[76px] rounded-[48px] border-[4px] border-gray-400 bg-slate-800 mt-10"
            />
            <button className="w-[268px] h-[68px] rounded-[100px]  border-[1px] bg-blue-700 text-white ml-[827px] mt-11 absolute">
              Auto Generate
            </button>
          </div>

          <button className="w-[268px] h-[60px] rounded-[48px]  border-[1px] bg-blue-700 text-white ml-[400px] mt-10">
            Shorten Now!
          </button>
        </div>
      </div>
